...
  if (n.eq("Infinity")) return "Infinity";
  ...
  if (n.lt("1e-10")) {
    ...
    if (n.gte("1e1e39")) {
      let t7 = [];
      console.log((n.gte("1e1e57") ? loglog.div("3").floor().sub("6").mul("3") : new Decimal("39")).toString());
      for (let i = n.gte("1e1e57") ? loglog.div("3").floor().sub("6").mul("3") : new Decimal("39"); i.lte(loglog); i = i.add("3")) {
